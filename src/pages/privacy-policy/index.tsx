    ...
    <div className="bg-darkPrimary min-h-screen text-white">
      <div className="p-4 max-w-xl mx-auto">
        ...
        <div className="space-y-4 mt-10 leading-7">
          ...
          <p>
            At FitiTrack, we understand the importance of your privacy. That's
            why we've made it our mission to protect your personal information
            and ensure that your data is handled with the utmost care and
            respect.
          </p>
          <p>
            ...
            services you've requested. We're transparent about what we're
            collecting and how we plan to use it.
          </p>
          <p>
          ...
          <p>
            ...
            data protection laws, including the EU's General Data Protection
            Regulation (GDPR). We take our responsibilities seriously and are
